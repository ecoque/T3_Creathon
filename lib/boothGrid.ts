...
// AdminBooth['zone'] null'a izin verir (henüz krokiye yerleştirilmemiş stant
// anlamına gelir, bkz. isBoothPlaced). Bu dosyadaki diğer tüm yardımcılar ise
// her zaman ÇÖZÜLMÜŞ (null olmayan) bir bölge koduyla çalışır.
export type ZoneCode = 'Zone A' | 'Zone B' | 'Zone C' | 'Zone D';
